    ...
    for brain_file in file_names:
        ...
        with h5py.File(full_load_path, 'r') as hf:
            ...
            for exp in range(len(brain_t_switch_indices)):
                ...
                save_file = os.path.join(save_directory, f'{brain_name}_{key_id}_STA_dff.h5') #generate this file
            
            # ## rerunning to get 40 since got mem errors -- remove lines 72-74 later and uncomment above lines 64-69, reindent below lines, 
            # exp = 1
            # key_id = 'forty'
            # exp_brain_t = brain_t_switch_indices[exp]
