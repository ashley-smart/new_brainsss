## calls dff.py
## sbatch file to call is run_dff.sh
...
for date in dates:
    ...
    file_id = 'highpass_data_rem_light.h5'  ##looks for this tag in filename and runs analysis on it
    job_ids = []
    for fly in flies:
